--------------------------------------
-- DONNÉES DE TESTS DE LA BASE ZOO --
--------------------------------------

set datestyle to european;

-------------------------------------------
-- Cages (#numc, lieu, typec)
-----------------------------------------
...
-------------------------------------------
-- Animaux (noma, espece, sexe, pays, datea, #numc)
-------------------------------------------
...
insert into animal values ('bimbo','éléphant','m','afrique','12/01/2000',5);
insert into animal values ('baghera','panthère','f','afrique','24/03/2008',3);
insert into animal values ('roi lion','lion','m','afrique','2/02/2000',3);
insert into animal values ('simba','lion','f','afrique','11/03/1998',3);
...
insert into animal values ('baloo','ours','m','oceanie','6/06/2006',2);
...
insert into animal values ('tigrou','tigre','m','asie','14/07/2013',9);
insert into animal values ('ovni','poisson','f','asie','3/01/2016/',10);

-------------------------------------------
-- Gardiens (numg, nomg, adresse, dateg)
-------------------------------------------
...
--------------------------------------------
-- Animaux malades (#noma, nommal, datem, remede)
--------------------------------------------
insert into estmalade values ('cotcot','typhus','25/01/2012','medoc');
insert into estmalade values ('cotcot','typhus','4/05/2012','medoc');
insert into estmalade values ('cotcot','typhus','5/06/2012','medoc');
insert into estmalade values ('cotcot','gale','10/06/2013','medoc');
insert into estmalade values ('cotcot','typhus','10/06/2013','medoc');
insert into estmalade values ('cocorico','typhus','10/06/2013','medoc');
insert into estmalade values ('cocorico','typhus','10/06/2014','medoc');
insert into estmalade values ('cocorico','typhus','10/06/2015','medoc');
insert into estmalade values ('cocorico','gale','10/06/2015','medoc');
insert into estmalade values ('gaulois','typhus','10/06/2015','medoc');
insert into estmalade values ('baloo','grippe','10/06/2015','doliprane');
insert into estmalade values ('baloo','gale','23/02/2016','medoc');
insert into estmalade values ('baloo','typhus','23/02/2016','medoc');

--------------------------------------------
-- Responsables des cages (#numg, #numc)
--------------------------------------------
...
insert into soccupe values (6,6);
